...
description: Returns a uint4 containing a bitmask of the evaluation of the Boolean <expr> for all active lanes in the current wave. 
...
Returns a uint4 containing a bitmask of the evaluation of the Boolean <expr> for all active lanes in the current wave. 
